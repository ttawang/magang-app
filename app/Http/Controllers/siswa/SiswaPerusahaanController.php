...
class SiswaPerusahaanController extends Controller
{
    ...
    public function index()
    {
        ...
        $cek = DB::table('kelompok')->where('id_user', Auth::user()->id)->first();
        if($cek){
            ...
            $data['sisakuota'] = $kuota - DB::table('kelompok')->where('id_periode',$cek->id_periode)->where('id_perusahaan',$data['perusahaan']->id_perusahaan)->count();
            $data['periode'] = DB::table('periode')->where('id',$cek->id_periode)->first();
    ...
    public function daftarkelompok()
    {
        ...
        $data = DB::table('kelompok as kel')
            ...
            ->select(DB::raw('
                ...
                k.nama nama_kelas
            '))
            ->where('id_perusahaan',$cek->id_perusahaan)
            ->orderBy('nama','asc')
            ->get();
