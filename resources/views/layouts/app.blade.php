...
<html lang="en">
<head>
    <script src="https://kit.fontawesome.com/7d1508a36d.js" crossorigin="anonymous"></script>
  <meta charset="utf-8">
  ...
  <!-- SweetAlert2 -->
  <link rel="stylesheet" href="{{ url('AdminLTE-3.1.0/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css') }}">
  <!-- datatables ku -->
